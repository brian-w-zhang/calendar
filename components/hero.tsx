...
import { Calendar, BarChart, Eye } from 'lucide-react'
...
export default function HeroSection({
  ...
  // Show success toast and auto-open modal when calendar data is loaded
  useEffect(() => {
  ...
  return (
    <>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                {/* Connect button or View Summary button */}
                {!isSignedIn ? (
                  <Button
                  ...
                  >
                    ...
                    View My Summary ({calendarData.length} events)
                  </Button>
                )}
      ...
      <SummaryModal
        ...
        selectedTimeFrame={getTimeFrameLabel(selectedTimeFrame)}
      />
    </>
  )
}
